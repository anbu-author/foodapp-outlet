...
class NewCoupon_S6 extends StatefulWidget {
  const NewCoupon_S6({super.key});

  @override
  State<NewCoupon_S6> createState() => _NewCoupon_S6State();
}

class _NewCoupon_S6State extends State<NewCoupon_S6> {
